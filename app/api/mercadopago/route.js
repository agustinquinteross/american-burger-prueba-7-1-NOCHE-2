  ...
  try {
    ...
    const result = await preference.create({
      body: {
        ...
        back_urls: {
          success: 'https://american-burger.vercel.app/success', // Crearemos esta página luego
          failure: 'https://american-burger.vercel.app/',
          pending: 'https://american-burger.vercel.app/',
        },
